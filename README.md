...
| Gestión de proyectos | Alta de proyectos con tipo (lotización), servicios, áreas comunes, área total en m2, obras comprometidas y documentos base; modelado jerárquico proyecto -> manzana -> lote |
...
- [`docs/`](docs/README.md): documentación funcional, técnica y roadmap.
